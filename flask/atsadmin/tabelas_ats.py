...
class Cliente(Base):
    ...
    #enderecos = relationship ('Enderecocliente' , back_populates = 'cliente' ,
    #    cascade = "all, delete, delete-orphan" )
    #enderecos = relationship("Enderecocliente")
    endereco = relationship("Enderecocliente", back_populates="cliente")
...
class Enderecocliente(Base):
    ...
    codcliente = Column(Integer, ForeignKey('clientes.codcliente'), nullable=False)
    ...
    #cliente = relationship('Cliente', back_populates = 'enderecocliente')
